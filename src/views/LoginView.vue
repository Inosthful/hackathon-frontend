...
<template>
  <div class="login-view min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-50 to-pink-50 dark:from-gray-900 dark:to-gray-800 p-4">
    <div class="login-card max-w-md w-full">
      ...
      <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-8 space-y-6">
        ...
        <div class="text-center text-xs text-gray-500 dark:text-gray-500">
          <p>Mode développement : tu peux utiliser n'importe quel email/mot de passe</p>
        </div>
      </div>
    </div>
  </div>
